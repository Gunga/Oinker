...
Oink.create(message: "Is this CSS?", user_id: 5)
...
Oink.create(message: "FUCK. I fucking love Barbie. All pink errrthang", user_id: 9)
...
Oink.create(message: "Fuck routes... I'm about to choke someone.", user_id: 5)
